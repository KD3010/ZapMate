...
const Modal = ({isVisible, setIsVisible, header, onClick}: {
    isVisible: boolean,
    ...
    useEffect(() => {
        header === "Available Triggers" ? fetchAvailableTriggers() : fetchAvailableActions();
    ...
    >
        <div className='bg-white w-[40rem] h-96 rounded-md shadow-lg p-4'>
            <div className='flex items-center justify-between pb-2 border-b border-b-gray-300'>
                ...
                <svg onClick={() => setIsVisible(false)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="size-6 cursor-pointer">
